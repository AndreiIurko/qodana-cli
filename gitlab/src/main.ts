...
import {getInputs, prepareAgent, prepareCaches, pushQuickFixes, qodana, uploadArtifacts, uploadCache} from './utils'
import {extractArg, FAIL_THRESHOLD_OUTPUT, isExecutionSuccessful, QodanaExitCode} from '../../common/qodana'
...
async function main(): Promise<void> {
  try {
    ...
    await prepareCaches(inputs.cacheDir)
